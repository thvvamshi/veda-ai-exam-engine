...
const fileTextExtraction_service_1 = require("./fileTextExtraction.service");
const buildPrompt = async (assignment) => {
...
`)
    ...
    if (assignment.uploadedFileUrl) {
        extractedContext = await (0, fileTextExtraction_service_1.extractTextFromFile)(assignment.uploadedFileUrl);
    }
    // limit context size
